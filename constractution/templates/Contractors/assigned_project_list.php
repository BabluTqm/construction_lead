                ...
                <table class="table align-items-center mb-0">
                  ...
                  <tbody>
                    ...
                    <td>
                      ...
                      <td>
                        <h6 class=" mb-0 text-sm"><?php echo $assignedUser->project->user_profile->first_name." ".$assignedUser->project->user_profile->last_name ; ?></h6>
                      </td>

                      <td class="align-middle text-center text-sm">
                      <h6 class=" mb-0 text-sm"><?php echo $assignedUser->project->user->email  ; ?></h6>
                      </td>
                      <td class="align-middle text-center">
                      <h6 class=" mb-0 text-sm"><?php echo $assignedUser->project->user_profile->phone ; ?></h6>
                      </td>

                      <td class="align-middle text-center">
                      <h6 class=" mb-0 text-sm"><?php echo $assignedUser->project->created_date ; ?></h6>
                      </td>
