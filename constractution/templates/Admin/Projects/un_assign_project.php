      ...
      <div class="card my-4">
        <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
          <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
            <h6 class="text-white text-capitalize ps-3">Unassign Projects</h6>
          </div>
        </div>
                ...
                <td>
                  ...
                  <td class="align-middle">
                    ...
                    if($project->delete_status == 0){
                      echo $this->Form->postLink(__(''), ['controller' => 'Projects','prefix'=>'Admin','action' => 'unassignProjectDeleteRecover', $project->id], ['class'=>'fa-solid fa-recycle restore','id'=>'recycle',]);
                    }else{
                      echo $this->Form->postLink(__(''), ['controller' => 'Projects','prefix'=>'Admin','action' => 'unassignProjectDeleteRecover', $project->id], ['class'=>'fa-sharp fa-solid fa-trash delete']);
                    }
                    ?>
                  </td>
                </tr>
